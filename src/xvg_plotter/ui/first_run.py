...
class FirstRunDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Welcome to XVG Plotter")
        self.resize(560, 380)
        lay = QVBoxLayout(self)
        head = QLabel(self)
        head.setTextFormat(Qt.TextFormat.RichText)
        head.setText("<b>Double-click an .xvg, get a proper plot.</b>")
        ...
        bb.button(QDialogButtonBox.StandardButton.Ok).setText("Got it")
